...
public abstract class GenericInputDialogBuilder<T> {
	...
	public GenericInputDialogBuilder(final Context pContext, final int pTitleResID, final int
			pMessageResID, final int pErrorResID, final int pIconResID, final Callback<T>
			pSuccessCallback, final OnCancelListener pOnCancelListener){
		this(pContext, pTitleResID, pMessageResID, pErrorResID, pIconResID, "",
				pSuccessCallback, pOnCancelListener);
	}

	public GenericInputDialogBuilder(final Context pContext, final int pTitleResID,
									 final int pMessageResID, final int pErrorResID,
									 final int pIconResID, final String pDefaultText,
									 final Callback<T> pSuccessCallback,
		...
		.setPositiveButton(android.R.string.ok, new OnClickListener() {
			...
			public void onClick(final DialogInterface pDialog, final int pWhich) {
				...
				try{
					...
					Toast.makeText(GenericInputDialogBuilder.this.mContext,
							GenericInputDialogBuilder.this.mErrorResID, Toast.LENGTH_SHORT).show();
					return;
				}
