...
public abstract class SimpleAsyncGameActivity extends BaseGameActivity {
	...
	public abstract void onCreateResourcesAsync(final IProgressListener pProgressListener)
			throws Exception;
	public abstract Scene onCreateSceneAsync(final IProgressListener pProgressListener)
			throws Exception;
	public abstract void onPopulateSceneAsync(final Scene pScene, IProgressListener
	...
	@Override
	public void onPopulateScene(final Scene pScene, final OnPopulateSceneCallback
			pOnPopulateSceneCallback) {
		this.runOnUiThread(new Runnable() {

			@Override
			public void run() {
				ActivityUtils.doProgressAsync(SimpleAsyncGameActivity.this,
						"Populating Scene...", android.R.drawable.ic_menu_rotate,
