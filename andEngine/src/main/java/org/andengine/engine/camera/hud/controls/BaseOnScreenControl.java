...
public abstract class BaseOnScreenControl extends HUD implements IOnSceneTouchListener {
	...
	public BaseOnScreenControl(final float pX, final float pY, final Camera pCamera,
		...
		this.mControlBase = new Sprite(pX, pY, pControlBaseTextureRegion, pVertexBufferObjectManager) {
			...
			public boolean onAreaTouched(final TouchEvent pSceneTouchEvent,
				...
				return BaseOnScreenControl.this.onHandleControlBaseTouched(pSceneTouchEvent,
		...
		this.registerUpdateHandler(new TimerHandler(pTimeBetweenUpdates, true, new ITimerCallback() {
			...
			public void onTimePassed(final TimerHandler pTimerHandler) {
				BaseOnScreenControl.this.mOnScreenControlListener.onControlChange(
						BaseOnScreenControl.this,
						BaseOnScreenControl.this.mControlValueX,
						BaseOnScreenControl.this.mControlValueY);
			}
		}));
